...
namespace Promowork
{
    public partial class Compras : Form
    {
        ...
        {
            fechaFacturaDateTimePicker.MaxDate = DateTime.Today;
        ...
        private void bindingNavigatorAddNewItem_Click(object sender, EventArgs e)
        {
            ...
            idProveedorComboBox.SelectedValue = Proveedor["IdProveedor"];
            fechaFacturaDateTimePicker.Value = DateTime.Today;
            fechaRecibDateTimePicker.Value = DateTime.Today;
       ...
       private void radioButton2_CheckedChanged(object sender, EventArgs e)
       {
        ...
        private void textBox4_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {}
                ...
                if (proveedores != "")
                {
                    comprasCabBindingSource.Filter = "IdProveedor in (" + proveedores + ") and factura like '" + textBox5.Text + "%'" + filtroImporte;
                }
                else
                {
