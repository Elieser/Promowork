...
namespace Promowork
{
    public partial class Proveedores : Form
    {
        ...
        {
            if ((dNINIFProveedorTextBox.Text.Trim().Length == 0 || desProveedorTextBox.Text.Trim().Length == 0) && proveedoresDataGridView.RowCount != 0)
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            proveedoresDataGridView_CellEnter(null, null);
        }
        ...
        private void proveedoresDataGridView_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
